...
class CassiniViewController: UIViewController, UISplitViewControllerDelegate {
    ...
    /*
     ...
     a. just set our imageURL in teh detail if we're in a split view, or 
     b. cause the segue to happen from code with performSegue
     to make teh latter work, we had to create a segue in our storyboard
...
/*
 ...
 which eithe returns the view controller you send it to 
...
// extension 为了在iPad里ImageViewController 用到 UINavigationController，而iPhone 不需要。
